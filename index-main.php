...
$ nmcli connection add con-name janmesh autoconnect yes type wifi ifname wlan0 mode adhoc ssid http://janmesh.clewn.org<br/>
<br/>
<br/>
...
...then copy the script code provided in step 6 of the GUI installation below.<br/>
<br/>
...
Wifi tab -> ad hoc mode, essid http://janmesh.clewn.org<br/>
